...
def apply_licensed_classification(
    ...
    while the SES value is retained as evidence.

    Official licensed records absent from the SES financial inventory are
    retained with ``ses_present=false``. Regulatory scope must not depend on
    financial-file presence.
    """
